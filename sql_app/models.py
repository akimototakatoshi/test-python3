from sqlalchemy import Column, ForeignKey, Integer, String, DataTime 
...
class Booking(Base):
    ...
    start_datetime = Column(DataTime, nullable=False)
    end_datetime = Column(DataTime, nullable=False)
